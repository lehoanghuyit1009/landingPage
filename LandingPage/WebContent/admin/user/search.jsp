...
<%@ include file="/template/admin/inc/header-leftbar.jsp" %>
      <div id="content-wrapper">
              ...
              <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                	<div class="row justify-content-between">
	                	...
	                	<div class="col-sm-12 col-md-5">
	                		<form action="<%=request.getContextPath()%>/admin/user/search" method="get" class="d-flex input-group" id="search-form">
                	...
                	<div class="row">
                		<div class="col-sm-12">
		                	<table class="table table-hover table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="table-layout: fixed;">
		                  		<thead>
		                    		<tr role="row">
		                    			<th class="sorting_asc text-center" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 15px;">
		                    				Id
		                    			</th>
		                    			...
		                    			<th class="sorting text-center" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" >
		                    				Fullname
		                    			</th>
		                    			<th class="sorting text-center" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" >
		                    				Email
		                  		...
		                  		<tbody>
		                  			...
		                  			<tr role="row" class="odd">
					                    ...
					                    <td class="text-center"><%=item.getRole().getName()%></td>
										...
										<td class="center text-center">
											...
											<a href="<%=url %>/del?page=<%=currentPage%>&id=<%=item.getId()%>" class="btn btn-danger"
												onclick="return confirm('Are you want to delete <%=item.getFullname()%>?')">
		                    		...
		                    		%>
		                    		<tr><td colspan="7" style="text-align: center"><strong>0 User.</strong></td></tr>
		                    		<%
		                  				}
		                    		%>
								</tbody>
               		...
               		<div class="row">
               			<div class="col-sm-12 col-md-5">
               				<div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
               					<%
               						...
               						int to = (currentPage - 1) * DefineUtil.NUMBER_PER_PAGE + listUser.size();
               					%>
               					Showing <%=from%> to <%=to%> of <%=numberOfItems%> user
               				</div>
               			</div>
               			<div class="col-sm-12 col-md-7">
               				<div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
               					<ul class="pagination">
	               					<%
	                              		String href = request.getContextPath() + "/admin/user/index?name="+name+"&page=";
	                              	%>
	                              	<!-- Xử lí nut previous -->
        ...
        <script>document.getElementById('user').classList.add('active');</script>
        <script>
	    function getActive(trangthai,id){
	    	$.ajax({
	    		url: '<%=request.getContextPath()%>/admin/user/index',
	    		type: 'POST',
	    		cache: false,
