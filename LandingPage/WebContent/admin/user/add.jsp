      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="<%=request.getContextPath()%>/admin/user">Users</a>
            </li>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
	          <form action="" method="post">
	            <div class="form-group">
	              <div class="form-label-group">
	                <input type="text" name="username" value="<%if(username != null) out.print(username);%>" id="inputUsername" class="form-control"
	                 	placeholder="Username" pattern=".{5,32}" title="Username from 6 to 32 character" 
	            ...
	            <div class="form-group">
	              <div class="form-label-group">
	                <input type="email" name="email" value="<%if(email != null) out.print(email);%>" id="email" class="form-control"
	            ...
	            <div class="form-group">
	              <div class="form-label-group">
	                <input type="password" name="password" value="" id="inputPassword" class="form-control"
	                	placeholder="Password" pattern=".{6,32}" title="Password from 6 to 32 character" 
