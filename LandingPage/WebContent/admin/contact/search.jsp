...
<%@ include file="/template/admin/inc/header-leftbar.jsp" %>
      ...
      <div id="content-wrapper">
                		...
                		<div class="col-sm-12">
		                	<table class="table table-hover table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="table-layout: fixed;">
		                  		...
		                  		<tbody>
	                            		...
	                            		if (request.getAttribute("currentPage") != null)
		                  				...
		                  				if (listContact != null && listContact.size() > 0) {
		                  					for (Contact item : listContact) {
		                  						String url = request.getContextPath()+"/admin/contact";
		                  			%>
		                    		...
		                    		%>
		                    		<tr><td colspan="6" style="text-align: center"><strong>0 Contact.</strong></td></tr>
		                    		<%
		                  				}
		                    		%>
								</tbody>
               		...
               		<div class="row">
               			<div class="col-sm-12 col-md-5">
               				<div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
               					<%
               						...
               						int to = (currentPage - 1) * DefineUtil.NUMBER_PER_PAGE + listContact.size();
               					%>
               					Showing <%=from%> to <%=to%> of <%=numberOfItems%> contact
               				</div>
               			</div>
               			<div class="col-sm-12 col-md-7">
               				<div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
               					<ul class="pagination">
	               					<%
	                              		String href = request.getContextPath() + "/admin/contact/search?name="+name+"&page=";
	                              	%>
	                              	<!-- Xử lí nut previous -->
        ...
        <script>document.getElementById('contact').classList.add('active');</script>
        <script>
	    function getActive(trangthai,id){
	    	$.ajax({
	    		url: '<%=request.getContextPath()%>/admin/contact/index',
	    		type: 'POST',
	    		cache: false,
