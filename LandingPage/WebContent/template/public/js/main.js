$(document).ready(function() {
    ...
    if ($('#nav-menu-container').length) {
        ...
        /*
        $('#mobile-nav-toggle').on('vclick', function() {
        	console.log('haha');
        });*/
...
// youtube custom play button and thumbail script
    ...
    var onYouTubeIframeAPIReady = function () {
        player = new YT.Player('player', {
            height: '244',
            width: '434',
            videoId: '3xAxSkE9jVI',  // youtube video id
            playerVars: {
                'autoplay': 0,
                'rel': 0,
                'showinfo': 0
...
/*******
 * Code by itsontran.com
 * ****/    
/* Side bar fixed when scroll window 
 * copy from https://css-tricks.com/scrollfollow-sidebar/
 * 
*/
/*var $sidebar   = $("#sidebars-area"), 
	$window    = $(window),
